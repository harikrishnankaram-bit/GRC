...
export default function ServiceDetailPage() {
  ...
  const tabs = [
    ...
    },
    {
      ...
      icon: Wifi,
      description: `Leverage the power of our TRUSTGRID.AI compliance platform. Continuously scanning network packets, mapping data consent, and auditing workflows, the platform automates data validation.`,
      detailsTitle: "Key Details",
      details: [
