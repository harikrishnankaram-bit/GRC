...
export const aboutStats = [
  ...
  { label: "GRC & Security Experts", value: "5000+" },
  { label: "Enterprises Managed", value: "1000+" }
];

export const missionVisionValues = [
  { icon: Users, title: "Integrity First", desc: "Honesty and transparency are the bedrock of our GRC advisories." },
  { icon: Shield, title: "Unwavering Vigilance", desc: "Continuous automated monitoring of security control baselines." },
  { icon: Trophy, title: "Excellence Driven", desc: "Zero-deviation standards to ensure compliance pass rates." }
];

export const timelineData = [
  { year: "1985", title: "The Foundation", desc: "Established in Chennai, building a core foundation of elite risk management and compliance specialists.", align: "left" },
  { year: "2008", title: "National Expansion", desc: "Expanded operations and GRC consulting frameworks to 10 major cities across India.", align: "right" },
  { year: "2015", title: "Tech Integration", desc: "Launched proprietary GRC command dashboard software for real-time compliance monitoring.", align: "left" },
  { year: "2024", title: "Global Reach", desc: "Serving enterprises across Asia and Middle East with cutting-edge AI compliance and risk auditing.", align: "right" }
];
...
export const directorsData = [
  {
    ...
    bio: "A highly decorated former Indian Air Force officer and Founder of Govenics GRC, widely respected as 'SIR' Vijayakumar. Recipient of the Marusthal Seva Medal for meritorious service in desert terrain. Holds qualifications in Business Management and Law. Founded Security & Intelligence Resources (SIR) in 1994, building a professionally managed organisation delivering integrated compliance, loss-prevention, facilities management, and manpower solutions. An acknowledged industry leader with extensive contributions to corporate governance, compliance structures, risk management, and training."
  },
  {
    name: "Indiradevi",
    role: "Director",
    img: "/leaders/Indirani Director.jpeg",
    bio: "Director of Govenics GRC, playing an active role in financial oversight and strategic decision-making. Contributes valuable inputs to the finance function, supporting sound and sustainable business decisions. With a strong commitment to social service and employee welfare, she is an active member of the Inner Wheel Club. Instrumental in conceptualising and establishing Govenics' Staff Welfare Corpus Fund, through which numerous employees have benefited, reflecting the organisation's people-centric values."
  },
  {
    name: "V. Vishalkumar",
    role: "Director",
    img: "/leaders/Vishal ED.JPG",
    bio: "Director at Govenics GRC, representing the next generation of leadership. Brings international corporate experience from Accenture (PMO professional) and Forest Coach Lines, Sydney (Transport Analyst). His multidisciplinary academic foundation includes Computer Engineering, Master's in Logistics & Transport Management (University of Sydney), Law, Human Resources Management, Fire & Industrial Safety, and NEBOSH certification. This unique blend enables him to design robust, compliant, and risk-aware GRC operational frameworks."
  }
];
...
export const executiveManagementData = [
  {
    ...
    bio: "Executive Director leading initiatives focused on strengthening compliance, audit systems, and scalable growth. With global academic exposure and international experience, he brings a structured, technology-driven approach. Education: B.Sc. Mechanical Engineering (SUNY), M.Sc. Transport & Logistics (TUM Germany), Postgraduate Diploma in Fire & Industrial Safety, NEBOSH IGC, and LL.B (Government Law College, Madurai)."
  },
  {
    name: "Rajkumar Sankaran",
    role: "Executive Director",
    img: "/leaders/Rajkumar ED.jpeg",
    bio: "Executive Director since 2017, leading strategic growth across GRC advisory services, manpower solutions, and compliance frameworks. Over 25 years of experience in operations, compliance, and global project delivery with clients including Barry-Wehmiller, Henry Schein, and BOC. Holds MBA (ICFAI) in Supply Chain Management & Operations, and Bachelor of Law (BL) focused on Company Law and Labour Legislation. Emphasizes operational excellence, data-driven decision-making, and employee welfare."
  },
  {
    name: "S. Yuvaraj",
    role: "CEO",
    img: "/leaders/Yuvaraj CEO.jpg",
    bio: "MBA, LLB, a seasoned leader with deep expertise in GRC administration, governance, and statutory compliance. Drives strategic direction with a strong focus on operational integrity, risk management, and regulatory adherence. With prior service in the Indian Air Force and as Assistant Commissioner at EPFO, he brings proven experience in labour laws, audits, and enforcement, strengthening organizational governance and sustainable growth."
  }
];
